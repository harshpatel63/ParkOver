...
class HelloGeoRenderer(val fragment: ARFragment) :
  ...
  val displayRotationHelper = DisplayRotationHelper(fragment.activity)
  val trackingStateHelper = TrackingStateHelper(fragment.activity)
