...
class HelloGeoView(val fragment: ARFragment) : DefaultLifecycleObserver {
  val root = View.inflate(fragment.activity, R.layout.fragment_ar, null)
  ...
  fun updateStatusText(earth: Earth, cameraGeospatialPose: GeospatialPose?) {
    fragment.requireActivity().runOnUiThread {
      val poseText = if (cameraGeospatialPose == null) "" else
        fragment.requireActivity().getString(R.string.geospatial_pose,
      ...
      statusText.text = fragment.resources.getString(R.string.earth_state,
